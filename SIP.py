...
class SIPClient:
    ...
    def gen_cancel(self, request: SIPMessage) -> str:
        """Generiert einen CANCEL-Request basierend auf dem ursprünglichen INVITE"""
        message = f"CANCEL {request.uri} SIP/2.0\r\n"
        
        # Wichtige Header kopieren
        headers = [
            "Via",
            "From",
            "To",
        ...
        for header in headers:
            if header in request.headers:
                message += f"{header}: {request.headers[header]}\r\n"
